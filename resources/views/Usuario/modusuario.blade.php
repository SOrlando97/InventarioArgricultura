...
<section class="text-center ">
    <!-- Background image -->
    <div class="mt-4 bg-image" style="height: 200px;"></div>
    <!-- Background image -->
        ...
        <div class="col-lg-6">
            ...
            <form  method="POST" action="{{ route('change.password')}}">
                ...
                <div class="row mb-3 text-center mt-3">
                    <label class="col-md-3 col-form-label mt-4 " for="current_password" >
                    ...
                    <label class="col-md-3 col-form-label mt-4 text-left" for="new_confirm_password" >
          ...
          <div class="col-lg-6">
            ...
            <form  method="POST" action="{{ route('change.user')}}">
                ...
                @method('PUT')
                <div class="row mb-3 text-center mt-3">
                    <label class="col-md-4 col-form-label mt-4" for="nombre_usuario" >
                    ...
                    <label class="col-md-4 col-form-label mt-4" for="telefono" >
                        {{__('Telefono')}}
                    </label>
                    <div class="col-md-7">
