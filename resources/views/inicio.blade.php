...
<div class="firstSection ">
        <div class="servicios"> Conoce nuestros servicios </div>
</div>   
   <div class="SectionOne">
           ...
           <div class="main-card">
                <div class="imgBx"></div>
                <p class="p">Identifica tus productos usando un Codigo QR</p>
           </div>
           <div class="main-card">
     ...
     <div class="col-4">
        <div class="card-landing">
          <div class="row">
            ...
            <div class="col-8">
                <p class="m-3">Maneja tú información en un solo lugar </p>
            </div>
          </div>
        </div>
        <div class="card-landing ">
          <div class="row">
            ...
            <div class="col-8">
                <p class="m-3">Consulta tú inventario desde cualquier parte del mundo</p>
            </div>
          </div>
        </div>
     </div>
