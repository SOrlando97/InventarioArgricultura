...
<div class="firstSection banner">
   <div class="row">
           ...
           <div class="main-card">
                <div class="imgBx"></div>
                <p class="p">Identifica Tus productos usando Codigo QR</p>
           </div>
           <div class="main-card">
     ...
     <div class="col-4">
        <div class="card-landing ">
                <div class="row">
                        ...
                        <div class="col-8">
                                Maneja tú información en un solo lugar
                        </div>
                </div>
        </div>
        <div class="card-landing ">
                <div class="row">
                        ...
                        <div class="col-8">
                                Consulta tú inventario desde cualquier parte del mundo
                        </div>
                </div>
        </div>
     </div>
        ...
        <div class="col-4">
                <div class="card-landing2 ">
                        <div class="row">
                                ...
                                <div class="col-8">
                                        Gestiona mejor tu información y el almacenamiento de datos
                                </div>
                        </div>
                </div>
                <div class="card-landing2 ">
                        <div class="row">
                                ...
                                <div class="col-8">
                                        no te preocupes por recordar la información de tu siembra, nosotros te ayudamos
                                </div>
                        </div>
                </div>
        </div>
        <div class="col-8">
                <div class="img-consulta2">
                </div>
        </div>
  </div>
</div>
     ...
     <div class="col-4">
        <div class="card-landing ">
                <div class="row">
                        ...
                        <div class="col-8">
                                Registra tus productos, el sistema no cuenta con limitantes
                        </div>
                </div>
        </div>
        <div class="card-landing ">
