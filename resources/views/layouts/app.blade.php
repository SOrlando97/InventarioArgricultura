...
<head>    
    ...
    <link rel="icon" href="/images/icons8.png">
    <!-- Fonts -->
...
<body> 
    <div class="div1"></div>
        <div class="div2" id="app">
            <div class="mydiv">
                <nav class="navbar fixed-top navbar-dark bg-dark navbar-expand-md navbar-light">
                    <div class="container">
                        ...
                        @guest
                        @else
                        <a class="navbar-brand navtext" href="{{ url('/home') }}">
                            {{ ('Home') }}
                        </a>
                        @endguest
                            ...
                            <ul class="navbar-nav ms-auto"> 
                                ...
                                @else
                                    ...
                                    <li class="nav-item dropdown">
                                        <a id="navbarDropdown" class="nav-link dropdown-toggle navtext text-capitalize" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                            {{ Auth::user()->name }}
                                        </a>
